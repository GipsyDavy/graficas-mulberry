...
public class DashboardView extends VBox {
    ...
    public DashboardView() {
        ...
        Label titulo = new Label(t("dash.titulo"));
        titulo.getStyleClass().add("view-title");

        Label subtitulo = new Label(tf("dash.subtitulo", LocalDate.now()));
    ...
    private FlowPane buildTarjetas() {
        ...
        flow.getChildren().addAll(
            tarjeta("c1", t("dash.kpi.clientes"),    "—", "#4C9BE8", "M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z",        t("dash.kpi.clientes.ctx")),
            tarjeta("c2", t("dash.kpi.presupuestos"), "—", "#F39C12", "M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z",                                                                                                                                                                                                     t("dash.kpi.presupuestos.ctx")),
            tarjeta("c3", t("dash.kpi.facturas"),    "—", "#E74C3C", "M18 17H6v-2h12v2zm0-4H6v-2h12v2zm0-4H6V7h12v2zM3 22l1.5-1.5L6 22l1.5-1.5L9 22l1.5-1.5L12 22l1.5-1.5L15 22l1.5-1.5L18 22l1.5-1.5L21 22V2l-1.5 1.5L18 2l-1.5 1.5L15 2l-1.5 1.5L12 2l-1.5 1.5L9 2 7.5 3.5 6 2 4.5 3.5 3 2v20z",                                                                                                             t("dash.kpi.facturas.ctx")),
            tarjeta("c4", t("dash.kpi.stock"),       "—", "#9B59B6", "M11.99 18.54l-7.37-5.73L3 14.07l9 7 9-7-1.63-1.27-7.38 5.74zM12 16l7.36-5.73L21 9l-9-7-9 7 1.63 1.27L12 16z",                                                                                                                                                                                                                             t("dash.kpi.stock.ctx")),
            tarjeta("c5", t("dash.kpi.facturado"),   "—", "#27AE60", "M15 18.5c-2.51 0-4.68-1.42-5.76-3.5H15l1-2H8.58c-.05-.33-.08-.66-.08-1s.03-.67.08-1H15l1-2H9.24C10.32 6.92 12.5 5.5 15 5.5c1.61 0 3.09.59 4.23 1.57L21 5.3C19.41 3.87 17.3 3 15 3c-3.92 0-7.24 2.51-8.48 6H3l-1 2h4.06c-.04.33-.06.66-.06 1s.02.67.06 1H3l-1 2h4.52c1.24 3.49 4.56 6 8.48 6 2.31 0 4.41-.87 6-2.3l-1.78-1.77C18.09 17.91 16.6 18.5 15 18.5z", t("dash.kpi.facturado.ctx"))
        );
        return flow;
    }
    ...
    private VBox tarjeta(String id, String titulo, String valor, String color, String iconPath, String contexto) {
        ...
        String tipText = switch (id) {
            case "c1" -> t("dash.kpi.clientes.tip");
            case "c2" -> t("dash.kpi.presupuestos.tip");
            case "c3" -> t("dash.kpi.facturas.tip");
            case "c4" -> t("dash.kpi.stock.tip");
    ...
    private VBox buildAvisosCalendario() {
        ...
        Label titulo = new Label(t("dash.avisos.titulo"));
        ...
        try {
            ...
            if (proximas.isEmpty()) {
                Label vacio = new Label(tf("dash.avisos.vacio", diasPanel));
                ...
                for (NotaCalendario nota : proximas) {
                    ...
                    Label lblDias = new Label(dias == 0 ? t("dash.avisos.hoy") : tf("dash.avisos.badge", dias));
